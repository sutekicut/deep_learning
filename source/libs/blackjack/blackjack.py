...
class BlackJack:
    ...
    def finish_game(self):
        print("player's hands: {player_hands}. player's score: {player_score}".format(player_hands=self.player.cards,
                                                                                      player_score=self.player.score))
        print("dealer's hands: {dealer_hands}. dealer's score: {dealer_score}".format(dealer_hands=self.dealer.cards,
